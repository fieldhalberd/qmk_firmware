...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX,    KC_LEFT, KC_UP,   KC_RGHT, DESKL,                     KC_WH_U, KC_BTN1, KC_MS_U, KC_BTN2, KC_WH_L, KC_BTN3,
    XXXXXXX, RERE,    COPY,    KC_DOWN, PSTE,    DESKR,                     KC_WH_D, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_R, XXXXXXX,
                                        LOWER,   KC_BSPC, KC_LWIN, KC_LALT, KC_SPC,  RAISE
  ),
